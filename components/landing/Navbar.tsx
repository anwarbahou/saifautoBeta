...
const Navbar = () => (
  <nav className="w-full bg-white rounded-b-2xl shadow-md py-3 px-6 flex items-center justify-between max-w-6xl mx-auto mt-6">
    <div className="flex items-center gap-8">
      ...
      <Link href="#" className="text-gray-700 font-medium hover:text-blue-700 transition">About Us</Link>
      <Link href="#" className="text-gray-700 font-medium hover:text-blue-700 transition">Our Fleet</Link>
      <Link href="#" className="text-gray-700 font-medium hover:text-blue-700 transition">Contacts</Link>
    </div>
