...
const HeroSection = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Redirect to search page with correct query params
  ...
  return (
    <section className="relative w-full h-[520px] flex flex-col items-center justify-center overflow-hidden rounded-2xl mt-8">
      ...
      <div className="absolute left-1/2 -bottom-12 -translate-x-1/2 w-[90%] max-w-4xl z-30">
        <form className="flex bg-white rounded-2xl shadow-lg overflow-hidden border-2 border-blue-100" onSubmit={handleSubmit}>
